...
out_folder = './output/SuppressFixG_' +mode+'_G=(%.2f,%.2f)L=%.3fMQ=%.2fMG=%.2fscreen=%.3f/'%(G, G1, L, mQ, mG, screen)
...
params_QG = {'G' : G, 'L': 0.75*L, 'screen': screen}
params_QG1 = {'G' : G1, 'L' : 0.75*L, 'screen' : screen}

params_GG = {'G' : G, 'L': 0.5*L, 'screen': screen}
params_GG1 = {'G' : G1, 'L' : 0.5*L, 'screen' : screen}
   
params_rep = params.copy()
params_rep['G'] = -params_rep['G']
params_rep1 = params1.copy()
params_rep1['G'] = -params1['G']
