...
lat1 = np.loadtxt(os.path.join(os.path.dirname(QuarkTM.__file__), "press_k4.mu2o2.txt"))
...
Trange_fit = df_fit.attrs['Trange']
...
plt.plot(lat1[::10, 0]*1e-3, lat1[::10, 1], ls='none', marker='o')
